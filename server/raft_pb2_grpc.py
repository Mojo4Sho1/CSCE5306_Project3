...
class RaftServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ForwardRequest = channel.unary_unary(
                ...
                request_serializer=raft__pb2.ForwardRequestMessage.SerializeToString,
                response_deserializer=raft__pb2.ForwardRequestResponse.FromString,
                _registered_method=True)
...
def add_RaftServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ForwardRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=raft__pb2.ForwardRequestMessage.FromString,
                    response_serializer=raft__pb2.ForwardRequestResponse.SerializeToString,
            ),
    }
...
class RaftService(object):
    ...
    def ForwardRequest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/raft.RaftService/ForwardRequest',
            raft__pb2.ForwardRequestMessage.SerializeToString,
            raft__pb2.ForwardRequestResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
