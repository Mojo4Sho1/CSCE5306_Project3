...
def test_parse_operation_with_colon_jwt():
    """_parse_operation handles JWT tokens that contain colons (e.g. 'user:pass')."""
    result = _parse_operation("UpdateLocation|joe:pw|1.0|2.0")
    assert result == ("joe:pw", 1.0, 2.0)
